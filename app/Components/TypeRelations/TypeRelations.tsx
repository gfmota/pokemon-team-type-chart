  ...
  return (
    <TypeRelationsStyled>
      <div>
        ...
        />{' '}
        {renderTypesList(typeRelations.x4)}
      </div>
      <div>
        <Image
          ...
          alt="it's super effective"
        />{' '}
        {renderTypesList(typeRelations.x2)}
      </div>
      <div>
        <Image
          ...
          width={64}
          height={64}
          alt="it doesn't affect"
        />{' '}
        {renderTypesList(typeRelations.x0)}
      </div>
      <div>
        <Image
        ...
        />{' '}
        {renderTypesList(typeRelations.x05)}
      </div>
      <div>
        <Image
          ...
          alt=" it's not very effective"
        />{' '}
        {renderTypesList(typeRelations.x025)}
      </div>
    </TypeRelationsStyled>
  );
};
